...
<template>
  ...
  <div class="min-h-svh bg-slate-50 px-60 py-12 flex flex-col gap-12">
    ...
    <div class="flex flex-col gap-2">
      ...
      <p class="text-slate-600">Manage your profile information and security settings.</p>
    </div>
      ...
      <div class="flex flex-col gap-4">
        <div class="flex flex-col gap-1">
          ...
          <input
            ...
            class="border border-slate-200 rounded-lg px-4 py-2 text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-600"
          />
        </div>
    ...
    <div class="rounded-xl border border-slate-200 bg-white/90 p-8 flex flex-col gap-4">
      <h2 class="text-xl font-semibold text-slate-800">Account Information</h2>
    ...
    <div class="rounded-xl border border-red-200 bg-white p-8 flex flex-col gap-4">
      ...
      <div class="flex justify-end">
        <ButtonComponent type="danger" text="Delete account" @click="deleteAccount">
          Delete account
        </ButtonComponent>
      ``
      </div>
